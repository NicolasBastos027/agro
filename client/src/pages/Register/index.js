            ...
            <body>
                ...
                <div  >
                    ...
                    <div className={styles.geral}>
                            ...
                            <input className={styles.container} type='password' placeholder='Insira sua senha...'></input>
                            <input className={styles.container} type='password' placeholder='Confirme sua senha...'></input>
                    </div>
                    <div>
